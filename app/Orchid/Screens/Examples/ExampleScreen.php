...
class ExampleScreen extends Screen
{
    ...
    {
        return 'Observe los porcentajes de asistencias de sus profesores en tiempo real';
    }
    ...
    {
        return [
            Button::make('Actualizar gráficos')
                ->method('showToast')
                ->novalidate()
    ...
    public function layout(): iterable
    {
        return [
            Layout::metrics([
                'Profesores Puntuales'    => 'metrics.sales',
                'Profesores Faltantes' => 'metrics.visitors',
                'Profesores con Permiso' => 'metrics.orders',
                'Total de Profesores' => 'metrics.total',
            ]),
